...
class SmartPhone(Product):
    ...
    accum_volume = models.CharField(max_length=255, verbose_name="Ёмкость аккамулятора")
    ram = models.CharField(max_length=255, verbose_name="Оперативная память")
    sd = models.BooleanField(default=False, verbose_name="Наличие cd карты")
    sd_volume = models.IntegerField(null=True, blank=True, verbose_name="Объём памяти")
    main_cam_mp = models.CharField(max_length=255, verbose_name="Количество мегапикселей главной камеры")
    frontal_cam_mp = models.CharField(max_length=255, verbose_name="Количество мегапикселей фронтальной камеры")
...
class CartProduct(models.Model):
    ...
    final_price = models.DecimalField(max_digits=9, decimal_places=2, default=0, verbose_name="Общая стоимость")
